"""Animus Typer app and all CLI command definitions."""
...
def rise(
    ...
    confirm_cb = make_confirm_callback(cfg)
    registry = build_tool_registry(cfg, session_cwd, confirm_cb)
    ...
    try:
        while True:
            ...
            if stripped.startswith("/"):
                if handle_slash_command(stripped, agent, session, cfg):
                    console.print()
                    continue
                else:
